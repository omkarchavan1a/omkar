        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            ...
            <div className="mx-auto aspect-video overflow-hidden rounded-xl object-cover sm:w-full lg:order-last flex items-center justify-center bg-muted">
              <Image
                  src="https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfGFsbHx8fHx8fHx8fDE3NjI3MjQ2OTZ8&ixlib=rb-4.1.0&q=80&w=1080"
                  width={600}
                  height={400}
                  alt="Hero image of a person using a smartphone"
                  data-ai-hint="mobile services"
